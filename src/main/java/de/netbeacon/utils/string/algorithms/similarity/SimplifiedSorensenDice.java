...
package de.netbeacon.utils.string.algorithms.similarity;

import java.util.ArrayList;
import java.util.List;

/**
 * Simplified Sorensen-Dice Algorithm
 *
 * Thanks to @Archduke Liamus#4846
 */
public class SimplifiedSorensenDice {
    ...
    public static float diceCoefficient(String a, String b, int sliceSize){
        ...
        List<String> ASlices = sliceString(a, sliceSize);
        List<String> BSlices = sliceString(b, sliceSize);
     ...
     */
    private static List<String> sliceString(String a, int sliceSize){
